        ...
        <Card className="max-w-2xl mx-auto border shadow-sm">
            ...
            >
                ...
                <CardContent className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <Label htmlFor="institution-address" className="font-normal text-gray-700">
                    ...
                    <div className="flex flex-col gap-4 p-4 border rounded-lg bg-gray-50">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-col gap-2">
                                <Label htmlFor="institution-linkedin" className="font-normal text-gray-600 text-sm">
                                    LinkedIn
                                </Label>
                                <Input
                            ...
                            <div className="flex flex-col gap-2">
                                <Label htmlFor="institution-instagram" className="font-normal text-gray-600 text-sm">
                                    Instagram
                                </Label>
                                <Input

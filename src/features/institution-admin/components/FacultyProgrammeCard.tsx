...
type FacultyProgrammeCardProps = {
...
export function FacultyProgrammeCard({
  facultyName,
  programmeName,
  programmeDescription,
  durationYears,
  onOpen,
}: FacultyProgrammeCardProps) {
  const { t } = useTranslation('features.institution-admin')
  const resolvedFaculty = facultyName?.trim() || t('faculties.pages.programmes.card.unknownFaculty')
  const resolvedTitle =
    programmeName?.trim() || t('faculties.pages.programmes.card.untitledProgramme')
        ...
        <div className="mt-auto flex items-center justify-end">
          ...
          >
            <Text
              ...
              variant="body"
            >
              {t('faculties.pages.programmes.card.open')}
            </Text>
          </Button>
        </div>
      </div>

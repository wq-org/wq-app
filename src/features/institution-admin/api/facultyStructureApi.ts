...
export type AppendProgrammeStructureToFacultyInput = {
  institutionId: string
  facultyId: string
  programme: CreateFacultyStructureInput['programme']
  programmeOfferings: CreateFacultyStructureInput['programmeOfferings']
  cohort: CreateFacultyStructureInput['cohort']
  cohortOfferings: CreateFacultyStructureInput['cohortOfferings']
  classGroup: CreateFacultyStructureInput['classGroup']
  classGroupOfferings: CreateFacultyStructureInput['classGroupOfferings']
}

export type AppendProgrammeStructureToFacultyResult = Omit<
  CreateFacultyStructureResult,
  'facultyId'
>

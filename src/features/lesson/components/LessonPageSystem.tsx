...
export function LessonPageSystem({
  ...
  return (
    <div className={cn('space-y-8', className)}>
          ...
          return (
            ...
            >
              ...
              {index < resolvedPages.length - 1 ? (
                <div className="mx-auto flex w-full max-w-[80vw] items-center gap-4 px-4 text-sm text-muted-foreground">
      ...
      {isEditing ? (
        <div className="mx-auto flex w-full max-w-[80vw] items-center gap-4 px-4">

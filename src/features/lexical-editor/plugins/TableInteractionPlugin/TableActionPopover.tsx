...
function ToggleRow({ icon, label, checked, onCheckedChange }: TableActionToggle): JSX.Element {
  return (
    <div
      role="button"
      tabIndex={0}
...
function ActionRow({ item, onClose }: { item: TableActionItem; onClose: () => void }): JSX.Element {
  return (
    <button
      type="button"
      onMouseDown={(event) => event.preventDefault()}

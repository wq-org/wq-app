            ...
            <CardContent className="flex flex-col p-6">
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        <Button className="w-fit cursor-pointer" onClick={() => onView?.(id)}>
                            View
                        </Button>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <div className={`flex items-center justify-center h-9 w-9 rounded-full border ${
                                    is_published 

...
export default function ImageTermMatchGame() {
  ...
  const [terms, setTerms] = useState<Term[]>([{ id: '1', value: '' }])
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <div className="flex justify-end">
              <span
                className={`text-xs ${
                  feedbackText.length > 450 ? 'text-orange-500' : 'text-gray-500'
                }`}
              >
            ...
            {terms.map((term, index) => (
              <Card
                ...
                className={`transition-shadow ${
                  correctTermId === term.id ? 'border-primary shadow-md' : ''
                }`}
              >
      ...
      <div className="flex justify-end">
        <Button
          ...
          disabled={
            !title.trim() ||
            !imagePreview ||
            terms.some((term) => !term.value.trim()) ||
            !correctTermId
          }
        >
          Save Game
        ...
        <CardHeader>
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold mb-1">{title || 'Game Preview'}</h2>
  ...
  const settingsContent = (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 text-sm">Configure game settings and preferences.</p>
      </div>
      <Card>
        <CardHeader>

...
export { TeacherProfileContent } from './components/TeacherProfileContent'
export { StudentProfileContent } from './components/StudentProfileContent'
export { InstitutionProfileContent } from './components/InstitutionProfileContent'

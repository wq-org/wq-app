...
-- Requires: 20260000000063_cloud_assets_03_indexes_constraints
-- =============================================================================
...
BEGIN
  ...
  -- Per-institution storage cap only (plan_catalog.storage_bytes_cap_default removed);
  -- NULL cap means unlimited and is handled by the IS NOT NULL guard below.
  SELECT sub.storage_bytes_cap
  INTO cap_bytes

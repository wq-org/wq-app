...
-- Requires: 20260000000001_baseline_schema (games, enum), 20260323000001_baseline_lms_rls_memberships (games.institution_id)
-- =============================================================================

-- -----------------------------------------------------------------------------
-- games.game_type is free-text (defined directly in baseline_schema; no enum)
-- -----------------------------------------------------------------------------
COMMENT ON COLUMN public.games.game_type IS
  'Open-ended game type identifier (text). App-defined.';

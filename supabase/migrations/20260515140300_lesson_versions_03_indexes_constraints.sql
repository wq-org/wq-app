...
CREATE INDEX IF NOT EXISTS idx_lesson_progress_version_id
  ON public.lesson_progress (lesson_version_id) WHERE lesson_version_id IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_lesson_progress_user_lesson_version
  ON public.lesson_progress (user_id, lesson_version_id)

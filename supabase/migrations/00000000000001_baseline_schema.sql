...
-- Partial cleanup target: strip legacy follow surfaces and follower-based access clauses.
-- =============================================================================
...
COMMENT ON TABLE public.user_institutions IS
  'DEPRECATED compatibility bridge. Canonical tenant membership lives in institution_memberships.';
...
COMMENT ON TABLE public.course_enrollments IS
  'Legacy enrollment surface. Canonical student access is classroom_members plus course_deliveries.';
...
CREATE INDEX IF NOT EXISTS idx_games_deleted_at ON public.games(deleted_at) WHERE deleted_at IS NULL;
...
-- =============================================================================
-- TABLE PRIVILEGES — Supabase API roles still need table grants before RLS
-- =============================================================================

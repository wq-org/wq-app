...
-- 2. Add RPC create_teacher_classroom so a primary teacher can create a
--    classroom without institution_admin privileges.
-- (The org-hierarchy class_group_id column was removed at the source in
--  institution_admin_02, so no decoupling step is needed here.)
-- =============================================================================
...
-- 2. RPC — teacher creates their own classroom

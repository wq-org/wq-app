-- =============================================================================
-- COURSE DELIVERY — one current delivery per classroom/course
-- =============================================================================
...
COMMENT ON FUNCTION app.publish_course_to_classrooms IS
  'Publish a teacher-owned course: snapshot course metadata, topics, and lessons; replace current classroom course_deliveries with a new active delivery.';

CREATE UNIQUE INDEX IF NOT EXISTS idx_course_deliveries_current_classroom_course
...
COMMENT ON INDEX public.idx_course_deliveries_current_classroom_course IS
  'Enforces one current non-deleted course delivery per classroom and course; archived rows preserve historical progress and analytics.';

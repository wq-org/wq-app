-- =============================================================================
-- Fix get_cloud_file_delete_blocker_message — lessons tenant via courses
-- =============================================================================
-- lessons has topic_id only; institution_id lives on courses (lessons → topics → courses).
-- Replaces broken reference to l.institution_id (PostgreSQL 42703).
-- =============================================================================

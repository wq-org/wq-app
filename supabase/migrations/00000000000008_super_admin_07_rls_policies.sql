...
-- No member/institution SELECT policy: members access entitlements only through the
-- list_my_institution_feature_flags() SECURITY DEFINER RPC (reads plan_version_entitlements).

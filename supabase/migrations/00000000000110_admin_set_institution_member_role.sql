...
COMMENT ON FUNCTION public.admin_set_institution_member_role(uuid, uuid, text) IS
  'Super-admin: updates profiles.role and active institution_memberships.membership_role for a user at an institution. Casts p_new_role to membership_role for the membership update.';

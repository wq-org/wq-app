...
COMMENT ON FUNCTION app.publish_course_to_classrooms IS
  'Publish a teacher-owned course: create course_versions snapshot (topics + lessons), pin topic/lesson versions, and create active course_deliveries for each classroom.';

...
-- Requires: 20260000000048_course_delivery_02_tables.sql
-- =============================================================================
...
CREATE INDEX idx_course_version_topics_institution_id ON public.course_version_topics (institution_id);
...
CREATE INDEX idx_course_version_lessons_course_version_id ON public.course_version_lessons (course_version_id);
CREATE INDEX idx_course_version_lessons_institution_id ON public.course_version_lessons (institution_id);

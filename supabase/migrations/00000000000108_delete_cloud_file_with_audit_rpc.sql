...
--     supabase/migrations/20260000000006_super_admin_04_functions_rpcs.sql)
--   - app.user_can_manage_cloud_file(uuid) (cloud_assets RLS helpers)
--   - public.cloud_files (20260000000062_cloud_assets_02_tables.sql)
--   - public.cloud_file_status enum (20260000000061_cloud_assets_01_types.sql)
-- =============================================================================

...
1. Block model and versioning
2. Optimistic save path with debounce
3. Realtime for collaborative notes
4. LWW conflict path
5. Offline queue and reconnect flush
6. PgBouncer validation and performance checks

---

## Out of scope for MVP

- CRDT-based collaborative merging
- horizontal database sharding
- Kafka-style event infrastructure

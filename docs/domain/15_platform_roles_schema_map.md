...
| Order | File                                                                                                | Domain                                                                                                                                                                                                                                                                                                                                       |
| ----- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1     | `20260000000001_baseline_schema.sql`                                                                | Profiles, institutions, LMS tables (courses, topics, lessons, games), teacher_followers, storage buckets, auth trigger                                                                                                                                                                                                                       |
| 2     | `20260000000002_super_admin.sql`                                                                    | `app.auth_uid()`, `app.is_super_admin()`, super_admin bypass on LMS, admin RPCs (list/delete/ban users), dev seed                                                                                                                                                                                                                            |
...
| …     | `20260000000047_course_delivery_*` … `008`                                                          | course_versions, snapshots, course_deliveries, lesson_progress/learning_events `course_delivery_id`, delivery helpers + RLS, attendance alignment                                                                                                                                                                                            |
| …     | `20260000000055_chat_*` … `015`                                                                     | conversations, conversation_members, messages, conversation_contexts, delivery-aware RLS                                                                                                                                                                                                                                                     |
| …     | `20260000000061_cloud_assets_*` … `022`; `20260000000067_storage_cloud_objects_rls_01_policies.sql` | `cloud_folders`, `cloud_files`, `cloud_file_links`, `cloud_file_shares`; ACL helpers; `storage.objects` policies for `…/files/…` paths joined to `cloud_files`                                                                                                                                                                               |
| …     | `20260000000068_notifications_*` … `030`                                                            | `notification_events`, `notification_deliveries`, `notification_preferences`; `create_notification_event_with_deliveries`, scoped prefs, dedupe                                                                                                                                                                                              |
| …     | integrated into `20260321000002_*`, `20260323000001_*`, `20260323000002_*`, `20260000000053/07`     | offering layer (`programme_offerings`, `cohort_offerings`, `class_group_offerings`), `classrooms.class_group_offering_id`, legacy drift views, `app.summarize_staff_scope_delivery`, and write-freeze posture for legacy enrollment/link paths                                                                                               |
...
From `20260000000055_chat_*` (Phase E). Institution-scoped; optional `conversation_contexts` binds classroom, course delivery, task, or game session.
...
From `20260000000068_notifications_*` … `030` (Phase F; runs after course delivery, chat, cloud).
...
Bucket `cloud` supports **two path layouts** after `20260000000067_storage_cloud_objects_rls_01_policies.sql`:

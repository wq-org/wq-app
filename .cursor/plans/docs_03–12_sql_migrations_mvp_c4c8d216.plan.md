...
| 06 Note                 | `**notes`**: `institution_id`, `owner_user_id` OR `task_group_id` (nullable), `scope` enum personal                                                                                                                                                                        |
...
| 11 Chat                 | `**conversations`**, `**conversation_members`**, `**messages**`: `institution_id`, type direct                                                                                                                                                                             |
